...
class UsabillaInternal {
    ...
    private static func preferedFormSize() -> CGSize {
        let formWidth: CGFloat = 640 // apple default widht for popUpForms
        let formHeight: CGFloat = 1000 // apple default height for popUpForms
        let screen = UIScreen.main.bounds
        let margin: CGFloat = 50 //(screen.size.width - formWidth) / 2
