...
```yaml
binary "https://raw.githubusercontent.com/usabilla/usabilla-u4a-ios-swift-sdk/v6.4.7-Xcode-11.5/Usabilla.json"
```
replace Xcode-11.5 with the required version eg. Xcode-10
