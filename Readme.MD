...
```yaml
binary "https://github.com/usabilla/usabilla-u4a-ios-swift-sdk/Usabilla.json"
```
The current Carthage release is build for Xcode 10.2.1
...
```
Only the SDK 6.4.0 is available for Xcode 11
