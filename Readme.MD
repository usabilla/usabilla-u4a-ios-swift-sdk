...
Due to an issue with swift 5.2 the current release is build with Xcode 11.3.1.  For the Xcode 11.4.1 build see the carthage section 
...
```
The current master release is build for Xcode 11.3.1.
