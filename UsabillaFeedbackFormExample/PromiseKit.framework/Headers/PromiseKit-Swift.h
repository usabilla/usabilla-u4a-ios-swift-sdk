...
*/
- (void)catchOn:(OS_dispatch_queue * _Nonnull)q policy:(enum PMKCatchPolicy)policy execute:(void (^ _Nonnull)(NSError * _Nonnull))body;
/**
...
*/
SWIFT_PROTOCOL_NAMED("Promisable")
@protocol Promisable
/**
...
*/
@property (nonatomic, readonly, strong) id _Null_unspecified promise;
@end


@interface UIView (SWIFT_EXTENSION(PromiseKit))
@end


@interface UIViewController (SWIFT_EXTENSION(PromiseKit))
@end
