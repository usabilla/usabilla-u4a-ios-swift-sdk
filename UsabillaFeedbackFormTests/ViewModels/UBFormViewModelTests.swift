        ...
        describe("UBFormViewModelTests") {
            ...
            context("When initilized with correct model") {
                it("should have correct values") {
                    ...
                    expect(formViewModel.getViewModel(forIndex: formViewModel.nextPageIndex)!.name).to(equal("Third"))
            ...
            context("When going to next pages") {
                it("should have correct data if it's a form page") {
                    let formViewModel = UBFormViewModel(formModel: self.model)
                    formViewModel.currentPageViewModel = formViewModel.getViewModel(forIndex: formViewModel.nextPageIndex)!
                    ...
                    expect(formViewModel.endPageViewModel).to(beNil())
                    expect(formViewModel.getViewModel(forIndex: formViewModel.nextPageIndex)!.name).to(equal("end"))
                    expect(formViewModel.isItTheEnd).to(beFalse())
                }
                it("should have correct data if it's an end page") {
                    ...
                    expect(formViewModel.getViewModel(forIndex: formViewModel.nextPageIndex)).to(beNil())
